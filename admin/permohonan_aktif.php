...
<div class="page-title">
    <h3>Data Permohonan Darah</h3>
    <p class="text-subtitle text-muted">dibawah ini adalah daftar permohonan darah yang masih aktif</p>
</div>
        ...
        <div class="col-12 table-responsive">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Permohonan Aktif</h4>
                </div>
                <div class="card-body px-0 pb-0">
                    ...
                    <div class="table-responsive">
                        <table class='table table-striped mb-0' id="table1">
                            ...
                            <tbody>
                                <?php foreach (db_findAll('permohonan', ['status' => '1']) as $p) : ?>
                                    <tr>
